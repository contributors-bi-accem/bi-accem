...
LOAD DATA INFILE '{modalite_file}' REPLACE INTO TABLE `ods_modalite`
FIELDS TERMINATED BY '{fieldseparator}'
LINES TERMINATED BY '{endofline}'
(`T_MODALITE_ID`,
`LibelleModalite`,
...
LOAD DATA INFILE '{observation_file}' REPLACE INTO TABLE `ods_observation`  
FIELDS TERMINATED BY '{fieldseparator}'
LINES TERMINATED BY '{endofline}'
(`T_OBSERVATION_ID`,
`CodeObservation`,
...
LOAD DATA INFILE '{compte_file}' REPLACE INTO TABLE `ods_compte`  
FIELDS TERMINATED BY '{fieldseparator}'
LINES TERMINATED BY '{endofline}'
(`T_COMPTE_ID`,
`Login`,
...
LOAD DATA INFILE '{lier_groupe_file}' REPLACE INTO TABLE `ods_lier_groupe`  
FIELDS TERMINATED BY '{fieldseparator}'
LINES TERMINATED BY '{endofline}'
(`id_lier_groupe`,
`id_user`,
...
LOAD DATA INFILE '{groupe_file}' REPLACE INTO TABLE `ods_groupe`  
FIELDS TERMINATED BY '{fieldseparator}'
LINES TERMINATED BY '{endofline}'
(`id_groupe`,
`nom_groupe`,
...
LOAD DATA INFILE '{liste_droits_file}' REPLACE INTO TABLE `ods_liste_droits`  
FIELDS TERMINATED BY '{fieldseparator}'
LINES TERMINATED BY '{endofline}'
(`id_liste_droits`,
`id_user`,
...
LOAD DATA INFILE '{succursale_groupe_file}' REPLACE INTO TABLE `ods_succursale_groupe`  
FIELDS TERMINATED BY '{fieldseparator}'
LINES TERMINATED BY '{endofline}'
(`id_sg`,
`province`,
...
LOAD DATA INFILE '{QuestionComplexe_file}' REPLACE INTO TABLE `ods_QuestionComplexe`  
FIELDS TERMINATED BY '{fieldseparator}'
LINES TERMINATED BY '{endofline}'
(`id_question_complexe`,
`type_filtre`,
`defaut`,
`rang`,
`param`,
...
LOAD DATA INFILE '{personne_file}' REPLACE INTO TABLE `ods_personne`  
FIELDS TERMINATED BY '{fieldseparator}'
LINES TERMINATED BY '{endofline}'
(`T_PERSONNE_ID`,
`Nom`,
...
LOAD DATA INFILE '{questionnaire_file}' REPLACE INTO TABLE `ods_questionnaire`  
FIELDS TERMINATED BY '{fieldseparator}'
LINES TERMINATED BY '{endofline}'
(`T_QUESTIONNAIRE_ID`,
...
LOAD DATA INFILE '{obs_descript_file}' REPLACE INTO TABLE `ods_obs_descript`  
FIELDS TERMINATED BY '{fieldseparator}'
LINES TERMINATED BY '{endofline}'
(`T_DESCRIPTEUR_ID`,
`T_OBSERVATION_ID`,
...
LOAD DATA INFILE '{obs_mod_file}' REPLACE INTO TABLE `ods_obs_mod`  
FIELDS TERMINATED BY '{fieldseparator}'
LINES TERMINATED BY '{endofline}'
(`id_obs_mod`,
@date_debut,
